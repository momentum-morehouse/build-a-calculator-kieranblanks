...
let displayVal = "0";
let pendingVal;
let evalStringArray = [] //hold all operations entered
...
let performOperation = (clickObj) => {
    ...
    switch (operator) {
        ...
        displayVal = evaluation + ''; //result of equation 
        displayValElement.innerText = displayVal;
        evalStringArray = [];
        break;
    default:
...
//Enables the operations buttons to work
for (let i = 0; i < calcOperatorBtns.length; i++) {
    calcOperatorBtns[i].addEventListener('click', performOperation,false);
}

//Enables the AC/clear button to remove data 
clearBtn.onclick = () => {
    displayVal = '0';
...
//Enables the backpace button to work
...
//Prevents calculator from adding multiple decimals 
decimalBtn.onclick = () => {
